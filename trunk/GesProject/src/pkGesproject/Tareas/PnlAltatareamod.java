...
public class PnlAltatareamod extends JScrollPane{
		...
		**
		...
		public void actionPerformed(ActionEvent e) {
			...
			//if (sqlDate1.getTime()< sqlDate2.getTime()){
					conexdb.executeUpdate("INSERT INTO TAREAS WHERE (nombre, id_wp, descripcion, presupuesto,f_ini, f_fin, observaciones) VALUES ('"+ jtxt[0].getText()+"','"+id_wp+"','"+textarea.getText()+"','"+jtxt[1].getText()+"','"+sqlDate1+"','"+sqlDate2+"','"+textarea2.getText()+"')");
